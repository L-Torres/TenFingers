...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public void init(Context context) {
        ...
        progressBar = (SeekBar) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.bottom_seek_progress);
        ...
        quality = (TextView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.quality);
...
//                    return;
                ...
                if (puaseListener != null) {
                    puaseListener.pauseResult(true);
                }
                onStatePause();
                ...
                if (puaseListener != null) {
                    puaseListener.pauseResult(false);
                }
                onStatePlaying();
    ...
    public interface PuaseListener {
        public void pauseResult(boolean result);
    }

    private PuaseListener puaseListener;

    public void addPuaseListener(PuaseListener puaseListener) {
        this.puaseListener = puaseListener;
    }
