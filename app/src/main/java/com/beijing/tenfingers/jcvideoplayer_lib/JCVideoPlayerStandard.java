package com.beijing.tenfingers.jcvideoplayer_lib;
...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void init(Context context) {
        ...
        batteryTimeLayout = (LinearLayout) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.battery_time_layout);
        ...
        battery_level = (ImageView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.battery_level);
        video_current_time = (TextView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.video_current_time);
        retryTextView = (TextView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.retry_text);
    ...
    public void onClick(View v) {
        ...
        if (i == fm.jiecao.jcvideoplayer_lib.R.id.thumb) {
            ...
            EventBus.getDefault().post(new EventBusModel(true, MyEventBusConfig.CLOSE_VIDEO));
            backPress();
        } else if (i == fm.jiecao.jcvideoplayer_lib.R.id.back_tiny) {
            EventBus.getDefault().post(new EventBusModel(true, MyEventBusConfig.CLOSE_VIDEO));
            backPress();
        } else if (i == fm.jiecao.jcvideoplayer_lib.R.id.quality) {
            LayoutInflater inflater = (LayoutInflater) getContext()
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View layout = inflater.inflate(fm.jiecao.jcvideoplayer_lib.R.layout.video_quality_items, null);
            quality_normal = (TextView) layout.findViewById(fm.jiecao.jcvideoplayer_lib.R.id.quality_normal);
            quality_high = (TextView) layout.findViewById(fm.jiecao.jcvideoplayer_lib.R.id.quality_high);
            quality_super = (TextView) layout.findViewById(fm.jiecao.jcvideoplayer_lib.R.id.quality_super);
...
//            pw.showAsDropDown(tv, -65, -10);
        } else if (i == fm.jiecao.jcvideoplayer_lib.R.id.quality_normal || i == fm.jiecao.jcvideoplayer_lib.R.id.quality_high || i == fm.jiecao.jcvideoplayer_lib.R.id.quality_super) {
    ...
    private BroadcastReceiver battertReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_BATTERY_CHANGED.equals(action)) {
                ...
                if (percent < 15) {
                    battery_level.setBackgroundResource(fm.jiecao.jcvideoplayer_lib.R.drawable.jc_battery_level_10);
                } else if (percent >= 15 && percent < 40) {
                    battery_level.setBackgroundResource(fm.jiecao.jcvideoplayer_lib.R.drawable.jc_battery_level_30);
                } else if (percent >= 40 && percent < 60) {
                    battery_level.setBackgroundResource(fm.jiecao.jcvideoplayer_lib.R.drawable.jc_battery_level_50);
                } else if (percent >= 60 && percent < 80) {
                    battery_level.setBackgroundResource(fm.jiecao.jcvideoplayer_lib.R.drawable.jc_battery_level_70);
                } else if (percent >= 80 && percent < 95) {
                    battery_level.setBackgroundResource(fm.jiecao.jcvideoplayer_lib.R.drawable.jc_battery_level_90);
                } else if (percent >= 95 && percent <= 100) {
                    battery_level.setBackgroundResource(fm.jiecao.jcvideoplayer_lib.R.drawable.jc_battery_level_100);
                }
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            ...
            startButton.setImageResource(fm.jiecao.jcvideoplayer_lib.R.drawable.jc_click_replay_selector);
