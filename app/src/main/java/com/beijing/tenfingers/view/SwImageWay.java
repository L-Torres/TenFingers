...
public class SwImageWay extends XtomObject {
     ...
     */
    public SwImageWay(Activity mContext, int albumRequestCode,
     ...
     * @param cameraRequestCode 拍照选择时startActivityForResult方法的requestCode值
     */
    public SwImageWay(Fragment mFragment, int albumRequestCode,
                      int cameraRequestCode) {
