 ...
 * 2019年8月7日09:41:22
 */
public abstract class BaseRecycleAdapter_order<T> extends RecyclerView.Adapter<BaseRecycleAdapter_order.BaseViewHolder> {
    ...
    public BaseRecycleAdapter_order(List<T> datas) {
        this.datas = datas;
    }

    public BaseRecycleAdapter_order(Context mContext, List<T> datas) {
        this.datas = datas;
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_EMPTY) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.empty_order_view, parent, false);
    ...
    @Override
    public void onBindViewHolder(BaseRecycleAdapter_order.BaseViewHolder holder, final int position) {
