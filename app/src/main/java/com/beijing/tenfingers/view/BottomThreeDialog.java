...
public class BottomThreeDialog  extends XtomObject {
    ...
    public BottomThreeDialog(Context context) {
        ...
        btnTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (buttonListener != null)
                    buttonListener.onTopButtonClick(BottomThreeDialog.this);
            }
        });
        btnMiddle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (buttonListener != null)
                    buttonListener.onMiddleButtonClick(BottomThreeDialog.this);
            }
        });
