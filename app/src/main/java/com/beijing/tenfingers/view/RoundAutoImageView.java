...
public class RoundAutoImageView extends ImageView {
    ...
    public RoundAutoImageView(Context context) {
        this(context, null);
    }

    public RoundAutoImageView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public RoundAutoImageView(Context context, AttributeSet attrs, int defStyle) {
