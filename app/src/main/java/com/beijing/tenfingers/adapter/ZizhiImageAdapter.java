...
public class ZizhiImageAdapter extends HemaAdapter implements View.OnClickListener {
    ...
    public ZizhiImageAdapter(Context mContext, View rootView,
                             ArrayList<String> images,ServiceProFragment fragment) {
        super(mContext);
...
//                mContext, new XtomImageTask.Size(100, 100));
