...
//售后列表适配器
public class RefundAdapter extends BaseRecycleAdapter_order<Order> {

    private ArrayList<Order> list = new ArrayList<>();
    private Context context;
    private MyOrderFragment fragment;
    public RefundAdapter(Context contex, ArrayList<Order> datas,MyOrderFragment fragment) {
        super(datas);
        this.context = contex;
        this.list = datas;
        ...
        if(list.get(position).getO_refund_status().equals("0")){
            ...
            switch (list.get(position).getO_status()){
                ...
                case "3":
                    ...
                    holder.getView(R.id.tv_one).setVisibility(View.VISIBLE);
            ...
            switch (list.get(position).getO_status()){
                ...
                case "3":
                    ...
                    ((LinearLayout) holder.getView(R.id.ll_all)).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Order order= (Order) v.getTag();
//                            Intent it=new Intent(context, RefundDetailActivity.class);
                            Intent it=new Intent(context, OrderDetailActivity.class);
                            it.putExtra("id",order.getId());
                            context.startActivity(it);
                        }
