 ...
 * 店内技师
 */
public class ShopTeachersAdapter extends BaseRecycleAdapter<Technicians> {
    ...
    public ShopTeachersAdapter(Context contex, ArrayList<Technicians> datas,String type,String id) {
        super(datas);
        this.context = contex;
        this.list = datas;
        this.type=type;
    ...
    protected void bindData(BaseViewHolder holder, int position) {
        ...
        if(!"".equals(list.get(position).getT_distance()) && list.get(position).getT_distance()!=null){
            if(list.get(position).getU_distance()!=null){
