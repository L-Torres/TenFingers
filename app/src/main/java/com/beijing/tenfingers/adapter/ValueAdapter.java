...
public class ValueAdapter extends BaseRecycleAdapter<CommonList.Children> {

    private ArrayList<CommonList.Children> list = new ArrayList<>();
    public ValueAdapter(Context contex, ArrayList<CommonList.Children> datas) {
        super(datas);
        this.context = contex;
        this.list = datas;
    }
...
//        ((TextView) holder.getView(R.id.tv_tag)).setVisibility(View.GONE);
        ...
        ((TextView) holder.getView(R.id.tv_name)).setText(list.get(position).getU_username());
        ...
        ((TextView) holder.getView(R.id.tv_date)).setText(list.get(position).getCreated_at());
