...
public class RefundDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextView tv_title, tv_status, tv_top, tv_apply, tv_name, tv_address,
            ...
            tv_total, tv_coupon, tv_real, tv_to_pay, tv_tip, tv_shop,tv_dp,tv_sqtk,tv_tkwc,tv_p_one,
            tv_p_two,tv_p_three,tv_phone,tv_refund;
...
//                        getNetWorker().order_refund_cancel_two(MyApplication.getInstance().getUser().getToken(), id);
        ...
        if(detail.getO_status().equals("4") ||
                detail.getO_status().equals("5")||
                detail.getO_status().equals("6")||
                detail.getO_status().equals("7")){
...
//        ll_refund.setOnClickListener(this);
    ...
    private class AlipayThread extends Thread {
        ...
        public void run() {
            // 构造PayTask 对象
            PayTask alipay = new PayTask(RefundDetailActivity.this);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (resultStatus) {
                case "9000":
                    ...
                    break;
                case "6001":
                    new ToastDialog.Builder(RefundDetailActivity.this)
