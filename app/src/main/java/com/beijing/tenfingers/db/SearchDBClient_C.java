 ...
 * 客户搜索缓存
 */
public class SearchDBClient_C extends BaseDBHelper {

	private static SearchDBClient_C mClient;

	private String tableName = SYS_CASCADE_SEARCH_CLIENT;

	public SearchDBClient_C(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public static SearchDBClient_C get(Context context) {
		return mClient == null ? mClient = new SearchDBClient_C(context)
				: mClient;
	}
