...
public class ShopOrderDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout ll_back,ll_teacher,ll_refund,ll_refund_process,ll_complete,ll_person,ll_advance_time,ll_go;
    private TextView tv_title,tv_status,tv_top,tv_apply,tv_name,tv_address,
            ...
            tv_total,tv_coupon,tv_real,tv_to_pay,tv_tip,tv_shop,tv_phone,tv_dp,tv_sqtk,tv_tkwc,tv_p_one,tv_reason,tv_ori,tv_refund,tv_service_type,
