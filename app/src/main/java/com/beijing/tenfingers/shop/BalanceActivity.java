...
public class BalanceActivity extends BaseActivity implements View.OnClickListener, TimePicker.OnTimeSelectListener {
    ...
    private LinearLayout ll_back,ll_pay, ll_coupon;
    private TextView tv_title,   tv_pro_name, tv_pro_price,
            tv_pro_content, tv_pro_time, tv_pay,  tv_total, tv_book,  tv_coupon,tv_member,tv_rule;
            ...
            case R.id.tv_book:
                ...
                popTipDialog.setButtonListener(new PopTipDialog.OnButtonListener() {
                    ...
                    public void onRightButtonClick(PopTipDialog dialog) {
                        getNetWorker().prepay_shop(MyApplication.getInstance().getUser().getToken(),pro_id,sid,pay_type,price,
                                "1",couponId,"2",String.valueOf(redFee),remark);
                        dialog.cancel();
                    }
                });
                popTipDialog.show();
...
//        }
    ...
    private class AlipayThread extends Thread {
        ...
        public AlipayThread(String orderInfo) {
            ...
            alipayHandler = new AlipayHandler(BalanceActivity.this);
        }
    ...
    private class AlipayHandler extends Handler {
        ...
        public AlipayHandler(BalanceActivity activity) {
