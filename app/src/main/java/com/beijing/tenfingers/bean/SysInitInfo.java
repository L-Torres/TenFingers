...
public class SysInitInfo extends XtomObject {
    ...
    private String sys_service_qq;// 我公司统一客服电话 前台客服解疑释惑专用，目前是"0531-67804172"
    ...
    private String recharge_content;//充值满赠描述
    ...
    public SysInitInfo(JSONObject jsonObject) throws DataParseException {
        if (jsonObject != null) {
            try {
                ...
                recharge_content = get(jsonObject, "goods_url");
                log_i(toString());
    ...
    public SysInitInfo(String sys_web_service, String sys_plugins, String start_img, String android_must_update, String android_last_version, String iphone_must_update, String iphone_last_version, String sys_chat_ip, String sys_chat_port, int sys_pagesize, String sys_service_phone, String sys_service_qq, String android_update_url,
                       String iphone_update_url, String apad_update_url,
                       String ipad_update_url, String iphone_comment_url,
                       String msg_invite, String recharge_content) {
