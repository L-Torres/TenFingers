...
public class ShowLargePicActivity extends HemaActivity {
	...
	private FrameLayoutExtension touch;
	@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		if (urllist != null && urllist.size() > 0) {
			mViewPager.setAdapter(new PhotoPagerAdapter(this, urllist, touch));
...
//		touch.getHelper().setDropdownCloseGradualBackground(getWindow().getDecorView().getBackground());
	    touch.getHelper().setDropdownCloseListener(new ViewHelper.DropdownCloseListener() {
			@Override
