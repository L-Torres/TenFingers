 ...
 * <p>
 * 1.本项目中发送网络请求不建议使用{@link #getDataFromServer(BaseNetTask)} 建议使用如下
 * 
 * <pre>
 ...
 * 
 */
public abstract class HemaActivity extends TorresActivity {
	...
	@Override
	protected void callBeforeDataBack(BaseNetTask netTask) {
		// TODO Auto-generated method stub
	}

	@Override
	protected void callAfterDataBack(BaseNetTask netTask) {
		// TODO Auto-generated method stub
	}

	@Override
	protected void callBackForGetDataSuccess(BaseNetTask netTask, Object result) {
		// TODO Auto-generated method stub
	}

	@Override
	@Deprecated
	public void getDataFromServer(BaseNetTask netTask) {
		log_e("本项目中不建议使用此方法");
	}
