...
public class XRecyclerView extends RecyclerView {
    ...
    public void removeHeaderView(View view) {
        ...
        sHeaderTypes.remove(Integer.valueOf(HEADER_INIT_INDEX + mHeaderViews.size()));
    ...
    public void onScrollStateChanged(int state) {
         ...
         * RecyclerView.SCROLL_STATE_DRAGGING = 1  正在被外部拖拽,一般为用户正在用手指滚动
        ...
        if(state == RecyclerView.SCROLL_STATE_IDLE){
            ...
            manager.sendBroadcast(new Intent("com.example.administrator.teamainsecond.xrecyclerview_scroll_stop"));
        }else{
            if(context == null){
                return;
            }
            LocalBroadcastManager manager = LocalBroadcastManager.getInstance(context);
            manager.sendBroadcast(new Intent("com.example.administrator.teamainsecond.xrecyclerview_scroll_scrolling"));
        }
