...
public class CustomLoadMoreView extends LinearLayout {
    ...
    public void initView(){
        ...
        View view = inflater.inflate(R.layout.loadmoreview, null);
...
//        progressView.setIndicatorColor(0x00080808);
//
//        progressView.setIndicatorId(ProgressStyle.BallScaleRippleMultiple);
